...
export const ExercisesMain = () => {
    ...
    return (
        <ScrollView style={globalStyles.container}>
            <TouchableHighlight
                onPress={() => goToExercises('Select-training')}
                underlayColor={ColorPalette[theme].main}
            >
            ...
            <TouchableHighlight
                onPress={() => goToExercises('Create-training')}
                underlayColor={ColorPalette[theme].main}
            >
                <View style={styles.containerBlock}>
                    <View style={styles.containerContent}>
            ...
            <TouchableHighlight
                onPress={() => goToExercises('Generate-training')}
                underlayColor={ColorPalette[theme].main}
            >
                <View style={styles.containerBlock}>
                    <View style={styles.containerContent}>
