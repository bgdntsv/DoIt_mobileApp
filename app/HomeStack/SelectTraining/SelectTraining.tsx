...
export const SelectTraining = () => {
    const trainings = useSelector(
        (state: STORE_TYPE) => state.training.trainings
    )
    ...
    useEffect(() => {
        if (isFocused) {
            navigation
                .getParent()
                ?.setOptions({ headerTitle: t('select_training') })
        } else {
            ...
            {trainings.length ? (
                ...
                <View>
                    <Text style={globalStyles.p}>
                        No trainings but you can create your own training
                    </Text>
                    <CustomButton
                        title={'Create training'}
                        onPress={goToAddTraining}
                    />
                </View>
            )}
        </ScrollView>
