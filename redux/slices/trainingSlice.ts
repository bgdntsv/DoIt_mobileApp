...
export const addTraining = createAsyncThunk<TRAININGS_STATE_TYPE | undefined, TRAINING_TYPE, {
    state: STORE_TYPE
...
export const changeTraining = createAsyncThunk<TRAININGS_STATE_TYPE | undefined, TRAINING_TYPE, {
    state: STORE_TYPE
...
export const deleteTraining = createAsyncThunk<TRAININGS_STATE_TYPE | undefined, string, {
    state: STORE_TYPE
